...
const Signup = () => {
  return (
    <div className="flex items-center">
      <div className="relative flex flex-col xl:w-[22%] xl:left-[39%] top-[200px] text-slate-600 items-center gap-8 p-4 border-4 border-white rounded-xl bg-purple-100">
